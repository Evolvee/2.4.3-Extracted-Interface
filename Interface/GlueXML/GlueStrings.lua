...
ABILITY_INFO_BLOODELF2 = "- May drain mana from opponents.";
...
AUTH_PARENTAL_CONTROL = "Access to this account has been blocked by parental controls.  Your settings may be changed in your account preferences at http://www.worldofwarcraft.com.";
...
BLIZZ_DISCLAIMER = "Copyright 2004-2006  Blizzard Entertainment. All Rights Reserved.";
...
CHAR_LOGIN_LOCKED_FOR_TRANSFER = "Your character is currently locked as part of the paid character transfer process.";
...
CLIENT_ACCOUNT_MISMATCH = "<html><body><p>Your account is authorized for an expansion that is newer than the installed version of World of Warcraft.  Please download the required data here <a href='http://www.worldofwarcraft.com'>www.worldofwarcraft.com</a></p></body></html>";
CLOSE = "Close";
...
LOGIN_BANNED = "This World of Warcraft account has been closed and is no longer available for use.  Please go to http://www.worldofwarcraft.com/misc/banned.html for further information. "; -- This is the error message players get when trying to log in with a banned account.
...
LOGIN_PARENTALCONTROL = "Access to this account has been blocked by parental controls.  Your settings may be changed in your account preferences at http://www.worldofwarcraft.com.";
...
LOGIN_SUSPENDED = "This World of Warcraft account has been temporarily suspended.  Please go to http://www.worldofwarcraft.com/misc/banned.html for further information."; -- This is the error message a player receives when trying to log in with a suspended account.
...
SCANDLL_MESSAGE_HACK = "[TEMPORARY] |cFFFF0000WARNING!\n\nThe third party cheat program \"%s\" has been found on your computer.|r\n\nPlease remove it before continuing to play. Use of this third party cheat program may cause your account to be closed or suspended"; -- Message displayed when a hack is discovered by Scan.dll.  %s contains hack name
SCANDLL_MESSAGE_SCANNING = "[TEMPORARY] Scanning for Trojans"; -- Message shown while running Scan.dll
SCANDLL_MESSAGE_TROJAN = "[TEMPORARY] |cFFFF0000ALERT!\n\nThe trojan \"%s\" has been found on your computer.|r\n\nPlease remove it before continuing to play. This trojan may be used to steal your personal account information"; -- Message displayed when a Trojan is discovered by Scan.dll.  %s contains Trojan name
...
SECONDS_ABBR = "Sec";
SECURITYMATRIX_DIRECTIONS = "[TEMPORARY] To complete your logon, follow the instructions to enter values from your matrix card";
SECURITYMATRIX_ENTER_CELL = "[TEMPORARY] Enter the value of cell |cFFFFFFFF%s%s|r then press OK. If you make a mistake press Clear";
...
SERVER_SPLIT = "This server is going though mitosis !!!";
SERVER_SPLIT_NOT_NOW = "Not now !";
SERVER_SPLIT_SERVER_ONE = "Server 1";
SERVER_SPLIT_SERVER_TWO = "Server 2";
