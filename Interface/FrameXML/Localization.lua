...
function Localize()
	...
	KNOWLEDGE_BASE_ARTICLE_URL = "http://support.wow-europe.com/kb/sendKBArticleQuery.xml";
	KNOWLEDGE_BASE_QUERY_URL = "http://support.wow-europe.com/kb/sendKBQuery.xml";
	KNOWLEDGE_BASE_SETUP_URL = "http://support.wow-europe.com/kb/getKBSetup.xml";
end
